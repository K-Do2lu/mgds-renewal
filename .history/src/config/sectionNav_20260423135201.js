...
export const subNavBySection = {
  ...
  recruit: [{ to: '/recruit/careers', label: '채용' }],
}
  ...
  business: [
    {
      ...
      thumb: new URL('../assets/img/business_item_01.svg', import.meta.url).href,
    },
    {
      to: '/business/partners',
      title: '파트너',
      lines: ['협력사와 함께하는', '비즈니스 생태계입니다.'],
      thumb: new URL('../assets/img/business_item_02.svg', import.meta.url).href,
    },
  ],
  notice: [
    {
