...
const tableData = ref([
    {title: '제목', date: '2026-04-21', view: 100, urlfile: false, hot: true},
    {title: '테스트제목입니다.', date: '2026-04-21', view: 100, urlfile: true, hot: true},
    {title: '제목', date: '2026-04-21', view: 100, urlfile: false, hot: false},
    {title: '제목', date: '2026-04-21', view: 100, urlfile: true, hot: false},
    {title: '제목', date: '2026-04-21', view: 100, urlfile: false, hot: false},
])
</script>
...
table{
    ...
    td{
        padding: 24px 20px;
        &.date, &.view{font-weight: 400; color: $txt-sub;}
